...
urls = {
    'Для поноса':'https://www.ozon.ru/category/deshevye-unitazy/',
    'Для остальных':'https://ru.riki.team/brands/fiksiki/'
    }
...
layout = [[sg.Text('Ультра ЕГЭ справочник', font=('Arial', 12))],
          [sg.Text('v0.1', font=('Arial', 12))],
          [sg.Combo(s, default_value=s[0], s=(15,22), enable_events=True, readonly=True, k='-COMBO-', key='Combo'),
          sg.Output(s=(60,30), key='outputt'),sg.Image('1.png',expand_x=True, expand_y=True)],
...
window = sg.Window('Пирогов Егор', layout,size=(715,350), keep_on_top=True)
